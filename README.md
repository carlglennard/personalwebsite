Hi! Welcome to my repository! This is a simple website where HTML, CSS, and JS is present. This project can be viewed by simply downloading the repository folder and opening one of the HTML files.
